...
class WebBookParser(BookParser):
    ''' self._url - (str) адрес страницы с книгой
        self._text_file - (str) имя итогового файла
        self._info - (dict) структура из self._create_info()
    '''
    def __init__(self, url, text_file):
        self._url = url
        self._text_file = text_file
        self._info = []
    
    def __str__(self):
        return 'WebBookParser v. 0.0.1.1'
